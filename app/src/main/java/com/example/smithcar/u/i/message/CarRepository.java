...
public class CarRepository {
    ...
    private CarRepository() {
        ...
        productList.add(new Product(
                ...
                "1 db",
                "Budapest",
                "Ez egy kiváló állapotban lévő BMW X5. Full extra, bőr belső, panoráma tető. Csak garázsban tartott, nem dohányzó tulajdonostól.",
                "+36 30 123 4567", // <--- Konkrét elérhetőség
                bmwImages // <--- A konkrét képlista
        ));
        ...
        productList.add(new Product(
                ...
                "+36 20 987 6543", // <--- Konkrét elérhetőség
                audiImages // <--- A konkrét képlista
        ));
        ...
        productList.add(new Product(
                ...
                "info@mercedes-fan.hu", // <--- Konkrét elérhetőség
                mercImages // <--- A konkrét képlista
        ));
    }
